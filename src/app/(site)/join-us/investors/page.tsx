...
export const metadata: Metadata = {
  title: {
    absolute: "Investors | AFAQ Partners",
  },
  description:
    "Access exclusive investment opportunities with AFAQ Partners.",
  openGraph: {
    title: "Investors | AFAQ Partners",
    description: "Access exclusive investment opportunities with AFAQ Partners.",
...
export default async function InvestorsPage() {
  ...
  const defaultHero = {
    ...
    subheadline: "AFAQ Partners provides qualified investors with access to transactions sourced through our deep network and relationships, not public listings. We focus on transparency, discipline, and alignment.",
  ...
  return (
    <main>
      <Hero
        ...
        subheadline="AFAQ Partners works with a focused group of investors who want more than a managed portfolio."
        image={heroImage}
        hasCTA={false}
      />
          ...
          <div className={styles.pullQuote}>
            ...
            <div className={styles.body} style={{ textAlign: 'center', maxWidth: '900px' }}>
              <p className={styles.pullQuoteText} style={{ marginBottom: '2rem' }}>
                AFAQ Partners works with a focused group of investors: HNW individuals, family offices, entrepreneurs, and qualified allocators who want more than a managed portfolio. They want a team that has been inside the deals, built the businesses, and deployed real capital across real markets.
              </p>
