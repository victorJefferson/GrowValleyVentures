...
export const metadata: Metadata = {
    title: {
        absolute: "Terms of Use | AFAQ Partners"
    },
    description: "Read the Terms of Use for AFAQ Partners' website and services.",
    openGraph: {
        title: "Terms of Use | AFAQ Partners",
        description: "AFAQ Partners's website terms and conditions.",
            ...
            <section className="section-padding">
                <div className="container">
                    <div className={styles.legalContent} style={{ textAlign: 'center' }}>
                        <p>
                            These Terms of Use govern your access to and use of the AFAQ Partners website, including all tools, content, and interactive features available on it.
                        </p>
                        <p>
                            By using this site, you agree to these terms. If you do not agree, please do not use the site.
                        </p>
                        <p>
                            This site is operated by AFAQ Partners LLC, registered in Dubai, United Arab Emirates.
                        </p>

                        <h2>WHAT THIS SITE IS FOR</h2>
                        <p><strong>What this website is — and isn&apos;t.</strong></p>
                        <p>
                            This website is a general information resource about AFAQ Partners, our services, and our capabilities. It is not a platform for transacting investments, and nothing on this site constitutes a solicitation, offer, or recommendation to buy or sell any financial product or security.
                        </p>
                        <p>
                        ...
                        <p>
                            If you are considering investing with AFAQ Partners, the appropriate step is to contact us directly and engage with our advisory team.
                        </p>

                        <h2>INVESTMENT DISCLAIMER</h2>
                        <p><strong>Tools are illustrative. They are not advice.</strong></p>
                        <p>
                            AFAQ Partners provides interactive financial tools on this website — including a portfolio planner, wealth calculator, and risk profiler. These tools are designed to help you explore your financial position and understand investment concepts.
                        </p>
                        <p>
                        ...
                        <p>
                            All content on this website — including text, graphics, logos, visual assets, tools, and underlying code — is the intellectual property of AFAQ Partners LLC or its licensors, and is protected by applicable copyright, trademark, and intellectual property laws.
                        </p>
                        <p>
                            You may not reproduce, distribute, modify, transmit, or use any content from this site for commercial purposes without prior written permission from AFAQ Partners.
                        </p>
                        <p>
                        ...
                        <p>
                            This site may contain links to third-party websites, tools, or resources. These links are provided for reference only. AFAQ Partners does not endorse, control, or take responsibility for the content, accuracy, or availability of any third-party site.
                        </p>
                        <p>
                        ...
                        <p>
                            To the fullest extent permitted by applicable law, AFAQ Partners, its entities, directors, employees, and advisors will not be liable for any direct, indirect, incidental, consequential, or punitive damages arising from your use of this website or reliance on any content, tool, or information contained within it.
                        </p>
                        <p>
