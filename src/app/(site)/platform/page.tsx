...
export const metadata: Metadata = {
    title: "The Investment Platform | AFAQ Partners",
    description: "AFAQ Partners operates an integrated capital platform, deploying capital into portfolio positions, structuring co-investment readiness, and managing institutional capital partnerships.",
    openGraph: {
        title: "The Investment Platform | AFAQ Partners",
...
export default function PlatformPage() {
    const platformTiles = [
        ...
        { title: "Capital Solutions", desc: "Structured capital readiness for qualifying businesses within the AFAQ Partners ecosystem." },
    ...
    return (
        <main>
            <Hero
                ...
                headline="The capital infrastructure of AFAQ Group."
                subheadline="The AFAQ Partners platform connects capital to opportunity across the portfolio, through co-investment frameworks, and for institutional partners seeking governed readiness."
                ...
                <div className="container">
                    <div className={styles.overview}>
                        ...
                        <p className={styles.body}>
                            AFAQ Partners operates an integrated capital platform, deploying capital into portfolio positions, structuring co-investment readiness, and managing institutional capital partnerships across active opportunities.
                        </p>
                        <p className={styles.body}>
